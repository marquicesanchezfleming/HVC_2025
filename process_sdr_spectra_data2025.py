...
def remove_spectral_bandpass(
    ...
    if doplot:
        ...
        plt.savefig(f"/Users/Djslime07/HVC_Project/Generated_Plots/spectrum_vs_rf_{startdate}_{starttime}.png")
        #plt.show()
...
if Nspectra > 1 and doplot == True:
    ...
    if do_diagnostic_plots:
        ...
        plt.savefig(f"/Users/Djslime07/HVC_Project/Generated_Plots/{zoomed_dynamic_spectrum_lb_plotfile}")
        ...
        plt.suptitle('Input file = ' + basenpzfile, fontsize=7)
        plt.savefig(f"/Users/Djslime07/HVC_Project/Generated_Plots/{zoomed_average_spectrum_plotfile}")
        #plt.show()
        ...
        plt.suptitle('Input file = ' + basenpzfile, fontsize=7)
        plt.legend()
        plt.savefig(f"/Users/Djslime07/HVC_Project/Generated_Plots/{fitted_zoomed_average_spectrum_plotfile}")
        #plt.show()
    ...
    flattened_ds_lb_plotfile =  'flattened_ds_lb_' + base_string + '_' + startdate + \
            '_' + starttime + '_Nspec_%d'%(Nspectra) + '.png'
    plt.savefig(f"/Users/Djslime07/HVC_Project/Generated_Plots/{flattened_ds_lb_plotfile}")
